/**
 * ⚠️ DEPRECATED: This function is for Stripe billing (legacy).
 * 
 * The app now uses Google Play Billing exclusively. This function is archived
 * and NOT called from the app. Keep for reference if implementing multi-provider
 * billing in the future.
 * 
 * To remove: delete this function and associated Stripe environment variables
 * from Supabase after confirming no active usage.
 */
